...
class IncomeRecordItem extends StatefulWidget {
  ...
  @override
  State<IncomeRecordItem> createState() => _IncomeRecordItemState();
}

class _IncomeRecordItemState extends State<IncomeRecordItem> {
